...
const navItems = [
  ...
  { name: "إدارة التنفيذ", href: "/dashboard/enforcement", icon: Gavel, permission: "manage_operations" },
  { name: "تحصيل الديون", href: "/dashboard/collections", icon: HandCoins, permission: "finance_basic" },
  { name: "تقويم الجلسات", href: "/dashboard/calendar", icon: Calendar },
  { name: "فحص التعارض", href: "/dashboard/conflict-check", icon: Zap, permission: "conflict_check" },
  ...
  { name: "حسابات الأمانة", href: "/dashboard/trust-accounting", icon: Landmark, permission: "finance_basic" },
  ...
  { name: "إدارة المستندات", href: "/dashboard/documents", icon: FileText, permission: "documents" },
  { name: "صانع العقود الذكي", href: "/dashboard/contracts", icon: FileEdit },
  { name: "إدارة العقود (CLM)", href: "/dashboard/clm", icon: FileSignature, permission: "manage_operations" },
  { name: "المحلل القانوني الذكي", href: "/dashboard/ai-analyzer", icon: Sparkles },
  { name: "بوابة الاستشارات", href: "/dashboard/advisory-desk", icon: MessageSquare, permission: "manage_operations" },
  { name: "الملكية الفكرية", href: "/dashboard/ip-operations", icon: Fingerprint, permission: "manage_operations" },
  { name: "المسارات المتخصصة", href: "/dashboard/specialized-tracks", icon: Layers, permission: "manage_operations" },
